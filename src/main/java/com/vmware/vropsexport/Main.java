...
public class Main {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        try {
            ...
            if (resourceKind != null) {
                final Exporter exporter = createExporter(host, username, password, threads, null, verbose, useTmpFile, 5000, 1000, trustStore, trustPass);
                ...
                try (final FileReader fr = new FileReader(defFile)) {
                    ...
                    final Exporter exporter = createExporter(host, username, password, threads, conf, verbose, useTmpFile, maxRows, maxRes, trustStore, trustPass);
    ...
    private static boolean promptForTrust(final X509Certificate serverCert, final String trustStore, final String trustPass) throws NoSuchAlgorithmException, KeyStoreException, CertificateException, IOException {
