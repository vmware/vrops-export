            ...
            new QueryAST.Not(
                    new QueryAST.And(
                            new QueryAST.Comparison(
                                    new QueryAST.Identifier("a"),
                                    new QueryAST.StringLiteral("a"),
                                    "EQ"),
                            new QueryAST.Comparison(
                                    new QueryAST.Identifier("b"),
                                    new QueryAST.StringLiteral("b"),
                                    "NE")));
            ...
            new QueryAST.Not(
                    new QueryAST.And(
                            new QueryAST.Not(
                                    new QueryAST.Or(
                                            new QueryAST.Comparison(
                                                    new QueryAST.Identifier("x"),
                                                    new QueryAST.DoubleLiteral(42),
                                                    "LT"
                                            ),
                                            new QueryAST.Comparison(
                                                    new QueryAST.Identifier("z"),
                                                    new QueryAST.DoubleLiteral(17),
                                                    "GT"
                                            ))),
                            new QueryAST.Comparison(
                                    new QueryAST.Identifier("a"),
